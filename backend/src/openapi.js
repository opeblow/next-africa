...
export const openapiSpec = {
  ...
  paths: {
    ...
    "/api/commitments/{id}": {
      patch: {
        tags: ["Commitments"],
        summary: "Update a commitment's status",
        security: auth,
        parameters: [{ name: "id", in: "path", required: true, schema: { type: "string", format: "uuid" } }],
        requestBody: { required: true, content: json({ type: "object", required: ["status"], properties: { status: { type: "string", enum: ["open", "waiting", "done"] } } }) },
    ...
    "/api/settings": {
      ...
      patch: {
        ...
        security: auth,
        requestBody: { required: true, content: json({ type: "object", required: ["proactivity_level"], properties: { proactivity_level: { type: "string", enum: ["quiet", "balanced", "active"] } } }) },
